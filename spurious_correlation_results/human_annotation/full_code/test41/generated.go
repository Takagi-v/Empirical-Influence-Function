...
func (d *Docker) TOML() string {
  ...
  ## Usage of this setting is discouraged since it will be deprecated in favor of 'perdevice_include'.   ## Set to true to report for each container per device blkio, network (eth0, eth1,...)   #
